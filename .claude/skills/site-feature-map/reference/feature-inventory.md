...
review against [UI-UX_Rulebook.md](../../../../docs/UI-UX_Rulebook.md) and
[SECURITY_Rulebook.md](../../../../docs/SECURITY_Rulebook.md).
...
| Search syntax | `section:` `type:` `year:` `lang:`; an unknown prefix is searched literally and said so | [state-and-data.md](../../site-state-and-tables/reference/state-and-data.md) §4 | **New** |
...
| Focus mode | One section on screen; `f`, the palette, or `?focus=`. Invisible while off | [state-and-data.md](../../site-state-and-tables/reference/state-and-data.md) §5a | **New** |
...
| QR code | A committed PNG. Dialog from the Links row for showing and downloading; 18mm in the masthead on paper | [printing.md](../../verify-print/reference/printing.md) §0 | **New** |
...
Reasons in [decisions-not-built.md](../../site-feature-map/reference/decisions-not-built.md). **Check there before
